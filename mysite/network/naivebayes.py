...
#print(my_vocab_list)
	...
	for line in textContentList:
		...
		solvedata = line['_source']['text']
		#print(solvedata)
		alldata = solvedata.lower().split()
		#print(alldata)
		# print("wangbadanwangbadan"+solveData[0])
		#RAWdata=json.loads(json.dumps(line))['_source']['text']
		#solveData=reg.split(json.loads(json.dumps(line))['_source']['text'])
		#print(solveData)
		...
		# 	sorted_wordP = re.sub(r'\(|\)', "", sorted_wordP)
		# 	print(sorted_wordP)
		# 	sorted_wordP = eval(sorted_wordP)
		# 	indexP  = 1
...
def show_wordcloud(keywword, name, period):
	context = queryES("the", "John", period)
	result = ''
	for line in context:
		solvedata = line['_source']['text']
		result = result + ' ' + solvedata
	wordcloud = WordCloud(
